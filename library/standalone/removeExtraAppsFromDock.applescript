...
on removeExtraAppsFromDock(prefs)
	...
	set defaultPrefs to {listOfAllowedAppNames:{"Finder", "FileMaker Pro Advanced", "FileMaker Pro", "Script Editor", "Terminal", "System Preferences", "Downloads", "Documents", "Trash"}}
